...
const services = [
  ...
  },
  {
    ...
    description:
      'Continuous monitoring and updates to keep your software running smoothly and securely.',
    icon: (
      <svg
        className="w-8 h-8 text-blue-600"
        fill="none"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            We provide a wide range of software development services to help you
